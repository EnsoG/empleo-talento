...
import { companyDetailsSchema } from "../../../schemas/panelSchemas";
...
export const CompanyDetailsForm = ({ companyId, companyData, sectors, onGetCompanyDetails: getCompanyDetails }: CompanyDetailsFormProps) => {
    ...
    const form = useForm({
        ...
        validate: zodResolver(companyDetailsSchema)
    });

    const handleSubmit = async (values: typeof form.values) => {
        const data = getModifiedFields(companyData, companyDetailsSchema.parse(values));
        ...
        await fetchData(`${endpoints.companies}/${companyId}`, {
            ...
            successMessage: "Datos corporativos actualizados con exito",
            method: "PUT",
            headers: {
